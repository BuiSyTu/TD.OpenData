	...
	<script id="add-template" type="text/html">
        <div class="m-form m-form--label-align-right p-3 row" tdf-type="form">
            <div class="form-group m-form__group row col-12">
                <label class="col-form-label col-3">Tên đơn vị</label>
                <div class="col-9">
            ...
            <div class="form-group m-form__group row  col-12">
                <label class="col-form-label col-3">Đơn vị cha</label>
                <div class="col-9">
                    <select class="select-parent bs-select form-control">
                        <option style="display:none;" value=0>Chọn đơn vị cha</option>
                    </select>
                </div>
            </div>
        </div>
